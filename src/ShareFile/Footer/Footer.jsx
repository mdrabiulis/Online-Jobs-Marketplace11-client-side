...
const Footer = () => {
  return (
    <div className="bg-[#f3f3fa]  font-roboto  mt-10">
      <footer className="footer p-10  max-w-7xl mx-auto">
        <nav >
          <header className="text-2xl font-bold border-b-2 text-[#6C53F8] border-[#3c47ad]">Categories</header>
        ...
        <nav >
          <header className="text-2xl font-bold border-b-2 text-[#6C53F8] border-[#3c47ad]">About</header>
        ...
        <nav >
          <header className="text-2xl font-bold border-b-2 text-[#6C53F8] border-[#3c47ad]">Support and Education</header>
        ...
        <nav >
          <header className="text-2xl font-bold border-b-2 text-[#6C53F8] border-[#3c47ad]">Community</header>
      ...
      <footer className="footer px-10 py-4 border-t bg-[#E2E5FE] text-base-content border-[#3c47ad] ">
        <aside className="items-center grid-flow-col  max-w-7xl mx-auto">
          <Logo ></Logo>
          <p className="pt-8">
          © e-Job International Ltd. 2023
          </p>
        </aside>
        <nav className="md:place-self-center md:justify-self-end max-w-7xl mx-auto">
